...
/**
 * Вспомогательный класс для загрузки тестовых данных из файлов.
 * Будет в дальнейшем пересмотрен.
 * @author Anton_Suryapin
 */
public class Utils {

    /**
    вспомогательный класс для загрузки данных из файлов:
    clients.txt,cars.txt,contracts.txt,managers.txt
     */
    ...
    /**
     * Метод загружает автомобили из файлов
     */
    ...
    /**
     * Метод загружает менеджеров из файлов
     */
    ...
    /**
     * Метод загружает контракты из файлов
     */
    ...
    /**
     * Метод загружает клиентов из файлов
     */
